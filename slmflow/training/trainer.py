...
from slmflow.training.data import prepare_dataset, DataCollator
from slmflow.training.optimizations import optimize_for_t4, get_memory_stats
...
class SLMTrainer:
    ...
    def __init__(
        self,
        model_config: Optional[SLMConfig] = None,
        ...
        *,
        ...
        # Log configuration
        logger.info(f"SLMTrainer initialized")
        ...
        logger.info(f"  Est. training time: ~{self.training_config.estimated_training_time_minutes} min")
