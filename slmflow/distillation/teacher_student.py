...
class DistillationTrainer:
    ...
    def __init__(
        self,
        student_model: Union[str, SLMConfig, PreTrainedModel],
        ...
        *,
        ...
        self._student_config = (
            student_model if isinstance(student_model, SLMConfig)
            else SLMConfig(model_name=student_model)
    ...
    def tokenizer(self):
        ...
        if self._tokenizer is None:
            self._tokenizer = load_tokenizer(
                self.distillation_config.teacher_model
            )
