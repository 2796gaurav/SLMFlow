...
def _quantize_gptq(
    ...
    try:
        ...
        raise ImportError(
            "GPTQ support requires: pip install optimum auto-gptq"
        )
    ...
    if which("convert-hf-to-gguf.py") is None:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Please install llama.cpp for local conversion."
            )
...
def _export_gguf_online(
    ...
    logger.info(
        "Using online GGUF conversion. "
        "For better performance, install llama.cpp locally."
    )
