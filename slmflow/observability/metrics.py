...
class MetricsCollector:
    ...
    def mean(self, metric_name: str, last_n: Optional[int] = None) -> Optional[float]:
        """
    ...
    def min(self, metric_name: str) -> Optional[float]:
        """Get minimum value for a metric."""
        values = self.get_values(metric_name)
        return min(values) if values else None
    
    def max(self, metric_name: str) -> Optional[float]:
    ...
    def to_dataframe(self, metric_name: Optional[str] = None):
        """
